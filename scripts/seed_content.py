...
SITE_CONTENT = [
    ...
    ('chatUser',
     'أتمتة إنشاء تقرير المبيعات الأسبوعي وإرساله بالبريد الإلكتروني كل يوم اثنين الساعة 8 صباحاً.',
     'Automate my weekly sales report generation and send it via email every Monday at 8 AM.'),
    ('chatAI',
     """✅ تم الفهم. سأقوم بإعداد:<br><br>1. مهمة Celery مجدولة يوم الاثنين 08:00 (توقيت القاهرة)<br>2. جلب البيانات من جداول مبيعات MySQL<br>3. إنشاء تقرير PDF منسق<br>4. إرساله عبر Flask-Mail<br><br>وقت التنفيذ: <strong style="color:var(--cyan)">ساعتان</strong>. هل تريد Telegram أيضاً؟""",
     """✅ Understood. I'll set up:<br><br>1. A scheduled Celery task for Monday 08:00 Cairo time<br>2. Pull data from your MySQL sales tables<br>3. Generate a formatted PDF report<br>4. Send via Flask-Mail with custom template<br><br>Estimated setup time: <strong style="color:var(--cyan)">2 hours</strong>. Should I also add Telegram notifications?"""),
    ...
    # Contact details — language-neutral (same value in both columns).
    ('cEmailVal', 'abubaker@hibbo.tech', 'abubaker@hibbo.tech'),
    ('cWAVal', '+20 1XX XXX XXXX', '+20 1XX XXX XXXX'),
    ('cWALink', '#', '#'),
    ('cLinkedinVal', 'linkedin.com/in/abubaker', 'linkedin.com/in/abubaker'),
    ('cLinkedinLink', '#', '#'),
    ('cGithubVal', 'github.com/HibooDeveloper', 'github.com/HibooDeveloper'),
    ('cGithubLink', 'https://github.com/HibooDeveloper', 'https://github.com/HibooDeveloper'),
